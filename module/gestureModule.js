...
var GestureModule = new Lang.Class({
    Name: 'GestureModule',
    ...
    _updateSettings: function () {
        this._leftThreeEnabled = true;
        this._leftThreeAction = 0;
        this._rightThreeEnabled = true;
        this._rightThreeAction = 0;
        this._upThreeEnabled = true;
        this._upThreeAction = 10;
        this._downThreeEnabled = true;
        this._downThreeAction = 10;
    ...
    enable: function () {
        ...
        this._gestureCallbackID = this.actor.connect('captured-event', Lang.bind(this, this._handleEvent));
...
Signals.addSignalMethods(GestureModule.prototype);